...
// Source: github.com/cloudtrust/elasticsearch-bridge/pkg/health (interfaces: InfluxHealthChecker,JaegerHealthChecker,RedisHealthChecker,SentryHealthChecker,FlakiHealthChecker,ElasticsearchHealthChecker,StoreModule)
...
// ElasticsearchHealthChecker is a mock of ElasticsearchHealthChecker interface
type ElasticsearchHealthChecker struct {
	ctrl     *gomock.Controller
	recorder *ElasticsearchHealthCheckerMockRecorder
}

// ElasticsearchHealthCheckerMockRecorder is the mock recorder for ElasticsearchHealthChecker
type ElasticsearchHealthCheckerMockRecorder struct {
	mock *ElasticsearchHealthChecker
}

// NewElasticsearchHealthChecker creates a new mock instance
func NewElasticsearchHealthChecker(ctrl *gomock.Controller) *ElasticsearchHealthChecker {
	mock := &ElasticsearchHealthChecker{ctrl: ctrl}
	mock.recorder = &ElasticsearchHealthCheckerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *ElasticsearchHealthChecker) EXPECT() *ElasticsearchHealthCheckerMockRecorder {
	return m.recorder
}

// HealthChecks mocks base method
func (m *ElasticsearchHealthChecker) HealthChecks(arg0 context.Context) []health.ElasticsearchReport {
	ret := m.ctrl.Call(m, "HealthChecks", arg0)
	ret0, _ := ret[0].([]health.ElasticsearchReport)
	return ret0
}

// HealthChecks indicates an expected call of HealthChecks
func (mr *ElasticsearchHealthCheckerMockRecorder) HealthChecks(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HealthChecks", reflect.TypeOf((*ElasticsearchHealthChecker)(nil).HealthChecks), arg0)
}
