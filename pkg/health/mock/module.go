...
// Source: github.com/cloudtrust/elasticsearch-bridge/pkg/health (interfaces: InfluxHealthChecker,JaegerHealthChecker,RedisHealthChecker,SentryHealthChecker,StoreModule)
